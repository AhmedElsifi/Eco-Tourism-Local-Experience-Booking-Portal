    ...
    <aside class="fixed left-0 top-0 h-full flex flex-col z-40 bg-[#f8faf5] w-72 border-r border-[#727972]/15">
        <div class="p-6 flex flex-col gap-2">
            <div class="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h1 class="text-2xl font-black tracking-tighter text-[#163422] font-headline uppercase">EcoPortal
                    </h1>
                    ...
                    <?php else: ?>
                        <div class="space-y-4">
                            <?php foreach ($bookings as $booking): ?>
                                <div
                                    class="bg-surface-container p-4 border-l-4 <?php echo $booking['status'] === 'confirmed' ? 'border-primary' : 'border-secondary'; ?>">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="text-right">
                                            <span
                                                class="px-3 py-1 text-xs font-bold uppercase bg-<?php echo $booking['status'] === 'confirmed' ? 'primary text-on-primary' : 'secondary text-on-secondary'; ?>">
                                    ...
                                    <div class="mt-2 text-xs text-on-surface-variant">Booking ID:
                    ...
                    <div class="grid grid-cols-3 gap-4 mb-8">
                        <div class="bg-surface-container p-6">
                            ...
                            <p class="text-4xl font-headline font-bold text-primary">
                                $<?php echo number_format($wallet['available_balance'] ?? 0, 2); ?></p>
                        </div>
                        <div class="bg-surface-container p-6">
                            <p class="text-sm text-on-surface-variant uppercase">Pending</p>
                            <p class="text-4xl font-headline font-bold text-secondary">
                                $<?php echo number_format($wallet['pending_balance'] ?? 0, 2); ?></p>
                        </div>
                        <div class="bg-surface-container p-6">
                            <p class="text-sm text-on-surface-variant uppercase">Withdrawn</p>
                            <p class="text-4xl font-headline font-bold text-tertiary">
                                $<?php echo number_format($wallet['withdrawn_balance'] ?? 0, 2); ?></p>
                        </div>
                    </div>
                        ...
                        <form method="POST" class="flex gap-4 items-end">
                            ...
                            <div>
                                ...
                                <input type="number" name="amount" step="0.01"
                                    class="border <?php echo isset($fieldErrors['amount']) ? 'border-error' : 'border-outline'; ?> p-3 w-40"
                                    placeholder="0.00" value="<?php echo htmlspecialchars($_POST['amount'] ?? ''); ?>">
                                <?php if (isset($fieldErrors['amount'])): ?>
                                    <p class="text-error text-sm mt-1"><?php echo $fieldErrors['amount']; ?></p>
                                <?php endif; ?>
                            </div>
                            <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Request
                                Withdrawal</button>
                        </form>
                    </div>
                                ...
                                <select name="tour_id" class="border border-outline p-3 w-full">
                                    ...
                                    <?php foreach ($tours as $t): ?>
                                        <option value="<?php echo $t['tour_id']; ?>">
                                            <?php echo htmlspecialchars($t['tour_name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="mb-4">
                                <label class="block text-sm font-bold mb-2">Report Content</label>
                                <textarea name="report_content" rows="5"
                                    class="border <?php echo isset($fieldErrors['report_content']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                                    placeholder="Describe conditions, wildlife sightings, etc..."><?php echo htmlspecialchars($_POST['report_content'] ?? ''); ?></textarea>
                                <?php if (isset($fieldErrors['report_content'])): ?>
                                    <p class="text-error text-sm mt-1"><?php echo $fieldErrors['report_content']; ?></p>
                                <?php endif; ?>
                            </div>
                            <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Post
                                Report</button>
                        </form>
                    </div>
                        ...
                        <?php else: ?>
                            <?php foreach ($fieldReports as $fr): ?>
                                <div class="bg-surface-container p-4 mb-3">
                                    <p class="text-xs text-on-surface-variant"><?php echo $fr['tour_name'] ?? 'General'; ?> |
                                        <?php echo date('M d, Y H:i', strtotime($fr['created_at'])); ?></p>
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="text" name="certificate_name"
                                        class="border <?php echo isset($fieldErrors['certificate_name']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                                        placeholder="e.g., Eco Guide Level 1"
                                        value="<?php echo htmlspecialchars($_POST['certificate_name'] ?? ''); ?>">
                                ...
                                <div>
                                    ...
                                    <input type="date" name="expiry_date" class="border border-outline p-3 w-full"
                                        value="<?php echo htmlspecialchars($_POST['expiry_date'] ?? ''); ?>">
                                </div>
                            </div>
                            <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Upload
                            ...
                            <?php foreach ($certifications as $cert): ?>
                                <div class="bg-surface-container p-4 mb-3 flex justify-between">
                                    <div>
                                        ...
                                        <p class="text-sm text-on-surface-variant">Issued: <?php echo $cert['issue_date']; ?> |
                                            Expires: <?php echo $cert['expiry_date'] ?? 'N/A'; ?></p>
                                    </div>
                                    <span
                                        class="px-3 py-1 text-xs font-bold uppercase <?php echo $cert['status'] === 'verified' ? 'bg-primary text-on-primary' : 'bg-secondary text-on-secondary'; ?>">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="language_id"
                                        class="border <?php echo isset($fieldErrors['language_id']) ? 'border-error' : 'border-outline'; ?> p-3 w-full">
                                        <?php foreach ($languages as $lang): ?>
                                            <option value="<?php echo $lang['language_id']; ?>" <?php echo (isset($_POST['language_id']) && $_POST['language_id'] == $lang['language_id']) ? 'selected' : ''; ?>><?php echo htmlspecialchars($lang['language_name']); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>
                                ...
                                <div>
                                    <label class="block text-sm font-bold mb-2">Certificate Name</label>
                                    <input type="text" name="certificate_name"
                                        class="border <?php echo isset($fieldErrors['lang_certificate_name']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                                        placeholder="e.g., DELE B2"
                                        value="<?php echo htmlspecialchars($_POST['certificate_name'] ?? ''); ?>">
                                    <?php if (isset($fieldErrors['lang_certificate_name'])): ?>
                                        <p class="text-error text-sm mt-1"><?php echo $fieldErrors['lang_certificate_name']; ?>
                                        </p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <?php foreach ($langCerts as $lc): ?>
                                <div class="bg-surface-container p-4 mb-3 flex justify-between">
                                    <div>
                                        ...
                                        <p class="text-sm text-on-surface-variant">
                                            <?php echo htmlspecialchars($lc['certificate_name']); ?></p>
                                    </div>
                                    <span
                                        class="px-3 py-1 text-xs font-bold uppercase <?php echo $lc['status'] === 'verified' ? 'bg-primary text-on-primary' : 'bg-secondary text-on-secondary'; ?>">
                                        <?php echo $lc['status']; ?>
                                    </span>
                                </div>
                            <?php endforeach; ?>
                        ...
                        <form method="POST">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <select name="tour_id"
                                        class="border <?php echo isset($fieldErrors['tag_tour_id']) ? 'border-error' : 'border-outline'; ?> p-3 w-full">
                                        <?php foreach ($tours as $t): ?>
                                            <option value="<?php echo $t['tour_id']; ?>">
                                                <?php echo htmlspecialchars($t['tour_name']); ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div>
                                    ...
                                    <select name="tag_name"
                                        class="border <?php echo isset($fieldErrors['tag_name']) ? 'border-error' : 'border-outline'; ?> p-3 w-full">
                        ...
                        <form method="POST">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    <label class="block text-sm font-bold mb-2">Select Tour</label>
                                    <select name="tour_id"
                                        class="border <?php echo isset($fieldErrors['itin_tour_id']) ? 'border-error' : 'border-outline'; ?> p-3 w-full">
                                        <?php foreach ($tours as $t): ?>
                                            <option value="<?php echo $t['tour_id']; ?>">
                                                <?php echo htmlspecialchars($t['tour_name']); ?></option>
                                        <?php endforeach; ?>
                                ...
                                <div>
                                    ...
                                    <select name="language_id" class="border border-outline p-3 w-full">
                                        <?php foreach ($languages as $lang): ?>
                                            <option value="<?php echo $lang['language_id']; ?>" <?php echo ($lang['language_id'] == 1) ? 'selected' : ''; ?>>
                                                <?php echo htmlspecialchars($lang['language_name']); ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                </div>
                            </div>
                            <div class="mb-4">
                                ...
                                <textarea name="content" rows="8"
                                    class="border <?php echo isset($fieldErrors['itin_content']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                            ...
                            <p class="text-sm text-on-surface-variant mb-4">Updating will trigger translation needed flags
                                for other languages.</p>
                            <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Update
                                Itinerary</button>
                        </form>
                    </div>
                                ...
                                <?php else: ?>
                                    <?php foreach ($itins as $i): ?>
                                        <div class="mt-2 p-2 bg-surface text-sm border-l-2 border-primary">
                                            <span class="font-bold"><?php echo $i['language_name']; ?>
                                                (v<?php echo $i['version']; ?>)</span>
                                            <p class="mt-1 whitespace-pre-wrap">
                                                <?php echo htmlspecialchars(substr($i['content'], 0, 200)); ?>...</p>
                                        </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
            ...
            <?php if ($activeTab === 'badges'): ?>
                <section>
                    ...
                    <div class="bg-surface-container p-6 mb-6">
                        ...
                        <p class="text-sm text-on-surface-variant mb-4">Submit credentials to earn badges based on your
                            expertise.</p>
                        <form method="POST">
                            ...
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="datetime-local" name="start_time"
                                        class="border <?php echo isset($fieldErrors['shadow_start_time']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                                ...
                                <div>
                                    ...
                                    <input type="datetime-local" name="end_time"
                                        class="border <?php echo isset($fieldErrors['shadow_end_time']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
            ...
            <?php if ($activeTab === 'identity'): ?>
                <section>
                    ...
                    <div class="bg-surface-container p-6 mb-6">
                        ...
                        <p class="text-sm text-on-surface-variant mb-4">Submit your identity document number for
                            verification.</p>
                        ...
                        <form method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="doc_number"
                                    class="border <?php echo isset($fieldErrors['doc_number']) ? 'border-error' : 'border-outline'; ?> p-3 w-full"
                                    placeholder="Enter ID number"
                                    value="<?php echo htmlspecialchars($_POST['doc_number'] ?? ''); ?>">
                                <?php if (isset($fieldErrors['doc_number'])): ?>
                                    <p class="text-error text-sm mt-1"><?php echo $fieldErrors['doc_number']; ?></p>
                                <?php endif; ?>
                            </div>
                            <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Submit for
                                Verification</button>
                        </form>
                    </div>
                </section>
                            ...
                            <div class="flex gap-4 mb-4">
                                <div>
                                    ...
                                    <input type="number" name="booking_id"
                                        class="border <?php echo isset($fieldErrors['voucher_booking_id']) ? 'border-error' : 'border-outline'; ?> p-3 w-40"
                                        placeholder="#" value="<?php echo htmlspecialchars($_POST['booking_id'] ?? ''); ?>">
                                    <?php if (isset($fieldErrors['voucher_booking_id'])): ?>
                                        <p class="text-error text-sm mt-1"><?php echo $fieldErrors['voucher_booking_id']; ?></p>
                                    <?php endif; ?>
                                </div>
                                <div class="flex items-end">
                                    <button type="submit" class="bg-primary text-on-primary px-6 py-3 font-bold">Check
                                        In</button>
                                </div>
                            </div>
                        </form>
                            ...
                            <?php foreach ($pendingBookings as $b): ?>
                                <div class="bg-surface-container p-4 mb-3 flex justify-between items-center">
                                    ...
                                    <form method="POST">
                                        ...
                                        <button type="submit" class="bg-primary text-on-primary px-4 py-2 font-bold text-sm">Confirm
                                            Check-in</button>
                                    </form>
                                </div>
                            <?php endforeach; ?>
